# `【MacOS】⚙️双击安装JobsCodeSnippets.command`
...
- 本自述文件对应脚本：`【MacOS】⚙️双击安装JobsCodeSnippets.command`。
- 脚本原始位置：`JobsGenesis@JobsCommand.iOS/配置相关`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️双击安装JobsCodeSnippets.command` |
| 所属目录 | `JobsGenesis@JobsCommand.iOS/配置相关` |
| 主要标签 | `通用脚本` |
| 是否涉及 Homebrew | `否` |
| 是否可能联网 | `是` |
| 是否含高风险命令 | `是` |
...
```shell
chmod +x './【MacOS】⚙️双击安装JobsCodeSnippets.command'
'./【MacOS】⚙️双击安装JobsCodeSnippets.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️双击安装JobsCodeSnippets.log`。

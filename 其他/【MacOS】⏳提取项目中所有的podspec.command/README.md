...
- 本自述文件对应脚本：`【MacOS】⏳提取项目中所有的podspec.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⏳提取项目中所有的podspec.command` |
...
```shell
chmod +x './【MacOS】⏳提取项目中所有的podspec.command'
'./【MacOS】⏳提取项目中所有的podspec.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⏳提取项目中所有的podspec.log`。

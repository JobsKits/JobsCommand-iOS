...
- 本自述文件对应脚本：`【MacOS】⚙️备份:恢复 iOS设备支持.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】⚙️备份:恢复 iOS设备支持.command` |
...
```shell
chmod +x './【MacOS】⚙️备份:恢复 iOS设备支持.command'
'./【MacOS】⚙️备份:恢复 iOS设备支持.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】⚙️备份:恢复 iOS设备支持.log`。

...
- 本自述文件对应脚本：`【MacOS】🚪双击打开系统的环境配置文件.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🚪双击打开系统的环境配置文件.command` |
...
```shell
chmod +x './【MacOS】🚪双击打开系统的环境配置文件.command'
'./【MacOS】🚪双击打开系统的环境配置文件.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🚪双击打开系统的环境配置文件.log`。

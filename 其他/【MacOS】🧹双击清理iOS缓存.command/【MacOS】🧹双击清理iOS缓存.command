#!/bin/zsh
# 脚本自述：
# - 脚本名称：【MacOS】🧹双击清理iOS缓存.command
# - 核心用途：执行“🧹双击清理iOS缓存”对应的移动端项目自动化任务。
...
show_readme_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】🧹双击清理iOS缓存.command'
  print -r -- '核心用途：执行“🧹双击清理iOS缓存”对应的移动端项目自动化任务。'

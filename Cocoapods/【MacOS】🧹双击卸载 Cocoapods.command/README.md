...
- 本自述文件对应脚本：`【MacOS】🧹双击卸载 Cocoapods.command`。
- 脚本原始位置：`JobsGenesis@JobsCommand.iOS/Cocoapods`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🧹双击卸载 Cocoapods.command` |
| 所属目录 | `JobsGenesis@JobsCommand.iOS/Cocoapods` |
| 主要标签 | `CocoaPods` |
| 是否涉及 Homebrew | `否` |
| 是否可能联网 | `否` |
| 是否含高风险命令 | `是` |
...
```shell
chmod +x './【MacOS】🧹双击卸载 Cocoapods.command'
'./【MacOS】🧹双击卸载 Cocoapods.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🧹双击卸载 Cocoapods.log`。

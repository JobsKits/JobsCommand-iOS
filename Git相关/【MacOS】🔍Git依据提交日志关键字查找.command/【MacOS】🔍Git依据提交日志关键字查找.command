...
# - 核心用途：执行“🔍Git依据提交日志关键字查找”对应的 Git / Sourcetree 自动化操作。
...
show_script_intro_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】🔍Git依据提交日志关键字查找.command'
  print -r -- '核心用途：执行“🔍Git依据提交日志关键字查找”对应的 Git 自动化操作。'
